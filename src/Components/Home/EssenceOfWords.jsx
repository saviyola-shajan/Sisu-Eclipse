...
export default function EssenceOfWords() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center  bg-gradient-to-b from-[#0f172a] to-[#7b2c18] text-white font-serif px-4 sm:px-6 md:px-10 lg:px-20 xl:px-32 py-10 sm:py-14 md:py-16">
      ...
      <div className="flex w-full max-w-7xl justify-around h-[450px]">
        {/* Left Words */}
        <div className="w-1/3 space-y-6">
          {words.map((item) => (
            <div
              ...
              className={`cursor-pointer ml-12 font-semibold text-4xl transition duration-200 ${
        ...
        {/* Right Meaning - vertically centered */}
        <div className="w-2/3 flex items-center justify-center text-center">
          <p className="text-3xl mb-16 text-orange-400 transition-all duration-300 max-w-2xl">
            “ {hoveredWord.meaning} ”
          </p>
        </div>
      </div>
