    ...
    <span>+353 83 874 2235</span>
        ...
        <div className="md:w-1/3 w-full text-sm text-center md:text-left">
          ...
          <ul className="space-y-2 text-lg font-normal">
            ...
            <li><Link to="/exclusive" className="hover:text-orange-400">Exclusive</Link></li>
            <li><Link to="/artists" className="hover:text-orange-400">Featured artists</Link></li>
            <li><Link to="/arts" className="hover:text-orange-400">Available arts</Link></li>
      ...
      <div className="text-center text-xs text-gray-400 space-x-4">
        ...
        <Link to="/terms-of-service" className="hover:text-orange-400">Terms of Service</Link>
      </div>
    </footer>
  );
}
